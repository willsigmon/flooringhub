 ...
 *
 * Wrapped in an IIFE (matching lib/nav-a11y.js) so the browser build's
 * top-level `api` identifier stays out of the shared classic-script global
 * scope -- it was colliding with lib/lead-form-validate.js's own top-level
 * `api`, throwing a SyntaxError that broke this file's execution entirely.
 */
(() => {
'use strict';
